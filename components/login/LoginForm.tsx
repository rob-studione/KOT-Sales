    ...
    <div className="m-auto w-full max-w-[440px] rounded-2xl border border-gray-100 bg-white p-8 shadow-lg">
      ...
      >
        ...
        <button
          type="submit"
          disabled={pending}
          className="mt-4 h-11 w-full rounded-lg bg-[#7C4A57] text-sm font-medium text-white shadow-md transition-all hover:bg-[#693948] hover:shadow-lg active:scale-[0.99] disabled:bg-gray-300 disabled:hover:bg-gray-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#7C4A57]/20 focus-visible:ring-offset-2"
        >
