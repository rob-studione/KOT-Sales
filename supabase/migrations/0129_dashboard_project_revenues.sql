-- Dashboard Pardavimai: vietoj cold/returning sąskaitų eilučių —
-- kompaktiškas projektų sąrašas (pavadinimas + bendra suma).
-- Atitikimas: project_revenue_feed (pirma kontaktas lange → sąskaita po kontakto).
