-- Projects candidates should consider only VAT invoices VK-000*,
-- excluding proforma (VK-000IS*) and credit notes (VK-000KR*).
--
-- Applies to BOTH interval aggregation and global (all-time) fields used by the candidates list.
