-- Add new completion result: "Įmonė likviduota" (completion_company_liquidated).
-- This must be treated as "closed" everywhere:
-- - unique index that allows only one open work item per client_key
-- - manual candidates "blocking" logic in fetch_manual_project_candidates_page

-- ---------------------------------------------------------------------------
-- 1) Unique index: allow repick after completion_company_liquidated
-- Latest canonical definition is in 0055_procurement_work_items_source.sql.
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 2) Manual candidates RPC: keep blocking list in sync with closed statuses
-- Latest canonical definition is in 0093_manual_candidates_status_rpc_timeout_fix.sql.
-- ---------------------------------------------------------------------------
