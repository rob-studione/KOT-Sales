-- Deterministinis rūšiavimas ir stabilus puslapiavimas (0047 papildymas).
-- Jei 0047 jau pritaikyta, pakanka paleisti šį failą arba `create or replace` iš 0047 kūno.
