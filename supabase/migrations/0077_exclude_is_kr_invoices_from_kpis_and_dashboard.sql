-- Exclude proforma/credit-type invoices from KPI and dashboards:
-- - invoice_number prefix VK-000IS* (išankstinės)
-- - invoice_number prefix VK-000KR* (kreditinės)
--
-- Important: this migration is intentionally additive (new file). Do not edit old applied migrations.

-- ------------------------------------------------------------
-- KPI RPC: vat_invoices_kpis
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- Dashboard RPC: dashboard_sales_analytics_v1 (latest definition incl. directInvoices companyName fix)
-- ------------------------------------------------------------
